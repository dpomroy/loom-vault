---
source: notes
source_path: sources/podcasts/acquired/2025-08-26-alphabet-inc.md
source_title: "Alphabet Inc."
source_date: 2025-08-26
show: "Acquired"
themes: ["AI & Technology", "Google History"]
...
The dependency risk here was existential, not theoretical. One hostile move from Microsoft — throttle IE, tweak Windows defaults — and the whole business is threatened. This is why the web-as-platform play wasn't optional.

### "They need to build up leverage with consumers, with users, that they're going to demand rich web applications so that if Microsoft ever tries to disadvantage Google… really the only defense against that is if consumers have already adopted this stuff and love it and would revolt."
...
This is the cleanest articulation of Google's
asymmetric strategy: **let Microsoft have the
revenue**, just erode the moat. Worth remembering
when thinking about how incumbents can be attacked
without out-earning them.

### "Google has the vast majority of users and usage of productivity software, and Microsoft still has the vast majority of dollars."

Users ≠ revenue, and Google is fine with that.
...
A **penny per view** is one of those units that
makes the scale visceral. The CFO was right to be
scared — this only works if you already own the
infrastructure and can wait years to fix the
business model.

### "YouTube, right early on said, you're a 50 ish percent partner, which takes you a decade longer to get profitable, but helps you build that base."

Deliberately **trading margin for supply-side
loyalty** is a hard call to defend internally for
a decade. The 50% split is what made YouTube
impossible to displace — creators had no incentive
to leave.

### "It abstracts the need at all to create or run a business. It really just simplifies it down to make content that people watch. You will get money for it."

This is the most honest description of what
**platform-as-employer** actually means. Relevant
to Loom — the feed that removes friction between
attention and value is the one that wins.

### "Last year in 2024, YouTube ads alone did $36 billion in revenue, half goes to creators, they have 18 billion left to play with"

YouTube's $36B in ad revenue with a 50% creator split is the number that reframes the whole deal. The "infrastructure costs will kill them" bear case turned out to be completely wrong.

The $1.65B purchase price looks embarrassing in hindsight — this is generational wealth destruction for whoever passed on it.

### "YouTube is already bigger than Disney's media business and this year will likely become bigger than Disney's entire business."

The Disney comparison is the clearest way to communicate YouTube's scale to a non-tech audience. Theme parks, cruise ships, merchandise — all of it, beaten by a website where people upload videos for free.

This is the kind of stat that should reframe how you think about user-generated content as an asset class.

### "Social networking, such as the conception of it existed in the mid two thousands and 2010s is dead. It's gone. It bifurcated into private messaging and public media."

This is the cleanest framing of a shift that took years to name. The "social graph" era is over — what replaced it is either intimate (WhatsApp) or anonymous-broadcast (YouTube, TikTok, Reels).
...
Decisive commitment beats better terms. Worth remembering as a negotiation principle.

### "There are ways that it systematically advantages you to own the exchange when you also own the network."

This is the honest framing of DoubleClick — it's a vertical integration play, not a mission-driven product. Google executives never evangelised it publicly because there's nothing inspiring to say about owning ad plumbing.

Structurally important, narratively invisible. Not every great business move makes a good slide deck.

### "Every year for the last 18 years, Google has been the number one seller of advertising of any kind in the world."

That streak — starting 2007 — is what makes the AI transition genuinely existential for Alphabet. The $200B search business depends on users querying a box. If that behaviour changes, the whole empire wobbles.
...
### "It's funny how giving it away for free as a startup is counter signal. It makes you look desperate. But if you're Google it's like, oh, they must have a really good plan here."

The **same strategy reads differently** depending on who's executing it. Andy Rubin's free OS pitch got ignored by carriers; Google's identical pitch got taken seriously. Credibility is distribution.
...
### "Android is still primarily protecting the core search ads business and making sure that traffic doesn't go elsewhere."
...
Google Plus broke every rule that made Google work — no bottom-up insight, no engineer passion, just mandated execution. This is the tell. When a company abandons its own operating model to fight a competitor, it's usually already lost.

### "Company-wide bonuses were based on the success of Google Plus, they even went so far as to put little plus one buttons on mobile advertisements"

Tying comp to a product with no product-market fit is how you poison a culture fast. Incentives reveal priorities — and these incentives told engineers their actual work didn't matter.

### "They reached deep to integrate with these other products... YouTube comments became Google plus posts, they almost killed the golden goose"

Forcing integration into YouTube — a product that was already winning — to serve a failing one is a textbook case of internal politics overriding user value. This is what happens when a VP has a mandate instead of a mission.

### "What great breakthrough consumer service did they launch after Google Plus?"

Ben asks it straight and David has nothing. That silence is damning. A decade of shipping hits, then a cliff. Google Plus didn't just fail — it appears to have **broken something structural** about how the company shipped.

### "YouTube is the winning paradigm in social media and UGC media. They should have just done nothing and just watch the money printer go burr."
...
Ben's thesis, held until the end deliberately. This is the most portable idea in the episode — a clean litmus test you can apply to any product, including Loom features.

### "Eric Schmidt said he would ask PMs, what is your core technical insight that makes it all work? And if there wasn't a good answer, he wouldn't fund the project."

Schmidt operationalised this instinct as a funding gate. That's not a vibe check — it's a hard filter. Rare to see a CEO enforce taste through process this cleanly.

### "The Google products that succeed wildly organically… are ones where there's almost no product. The technology solution is just so incredible that it is directly the user experience."

Ben draws the line between Google's organic wins and its engineered failures. The implication is uncomfortable: if your product needs UX design to compensate, you may not have the insight yet.
...
1. **Non-search products = platform defence**
 Every launch (Gmail, Maps, Chrome, Android)
 existed to stop Microsoft owning the layer
 Google's ad revenue depended on.

2. **Chrome was a survival move**, not a product
 Six deliberate architectural choices (V8, process-
 per-tab, Omnibox) won on genuine merit —
 but the motive was existential.

3. **Android's "less than free" model** paid
 carriers and OEMs rev-shares to adopt it —
 making rivals unable to compete on price
 before they could respond.

4. **YouTube is the best acquisition in tech history**
 $1.65B in stock → ~$500B standalone value;
 the 50% creator rev-share and algorithm-over-
 subscriptions model defined modern internet.

5. **Technical insight predicts Google success**
 Products built on a core technical breakthrough
 (Search, Maps, Chrome) win. Products conceived
 as experiences first (Plus, Wave) fail.

6. **Google Plus was a reorganisation, not a product**
 Larry used it to break internal fiefdoms;
 the real cost was opportunity cost — WhatsApp
 and cloud slipped away during the distraction.

7. **Google is a structural anomaly** — the only
 dominant platform company to survive and thrive
 across a full computing shift (web → mobile),
 where IBM and Microsoft both failed.
